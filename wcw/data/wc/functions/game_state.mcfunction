...
execute at @a[gamemode=survival,x=0,y=128,z=0,distance=126..] run particle item beef ~ ~ ~ 1 2 1 0 1000 normal
execute at @a[gamemode=survival,x=0,y=128,z=0,distance=126..] run playsound entity.squid.death master @a ~ ~ ~
