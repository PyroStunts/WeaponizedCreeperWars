...
execute at @a[gamemode=adventure] run summon creeper ~ 254 ~ {PersistenceRequired:1b,Invulnerable:1b,Tags:["pummel_creeper"],attributes:[{id:"minecraft:follow_range",base:1}]}
