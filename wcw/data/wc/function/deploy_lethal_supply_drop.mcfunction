...
execute at @a[gamemode=survival] run summon creeper ~ 254 ~ {PersistenceRequired:1b,Invulnerable:1b,Tags:["pummel_creeper"],attributes:[{id:"minecraft:generic.follow_range",base:1}]}
